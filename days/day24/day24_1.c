...
int main() {
    ...
    QueueElement head_values = {0, -1, 0, NULL};
    *head = head_values;
...
//        printf("%d, %d, time: %d\n", current->x, current->y, current->time);
        ...
        if (option_down && current->y + 1 == vertical_size && current->x + 1 == horizontal_size) {
        ...
        if (can_stay) {
            ...
            QueueElement new_element_values = {current->x, current->y, next_time, NULL};
        ...
        if (option_up && current->y - 1 >= 0) {
            QueueElement *new_element = malloc(sizeof(QueueElement));
            QueueElement new_element_values = {current->x, current->y - 1, next_time, NULL};
            *new_element = new_element_values;
        ...
        if (option_left && current->x - 1 >= 0 && current->y >= 0) {
            QueueElement *new_element = malloc(sizeof(QueueElement));
            QueueElement new_element_values = {current->x - 1, current->y, next_time, NULL};
            *new_element = new_element_values;
        ...
        if (option_right && current->x + 1 < horizontal_size && current->y >= 0) {
            QueueElement *new_element = malloc(sizeof(QueueElement));
            QueueElement new_element_values = {current->x + 1, current->y, next_time, NULL};
            *new_element = new_element_values;
